...
public interface ShoppingCartServer {
     ...
     * @Date: 3/22 8:26
     */
    ResponseEntity insert(ShoppingCart record);
     ...
     * @Date: 3/22 8:27
     */
    ResponseEntity insertSelective(ShoppingCart record);
     ...
     * @Date: 3/22 8:27
     */
    ResponseEntity updateByPrimaryKeySelective(ShoppingCart record);
     ...
     * @Date: 3/22 8:28
     */
    ResponseEntity updateByPrimaryKey(ShoppingCart record);
     ...
     * @Date: 3/22 8:28
     */
    ResponseEntity getPage(ShoppingCart record);
