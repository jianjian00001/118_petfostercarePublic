 ...
 * @description
 */
public interface OrderShippingServer {
     ...
     * @Date: 3/22 8:26
     */
    ResponseEntity insert(OrderShipping record);
     ...
     * @Date: 3/22 8:27
     */
    ResponseEntity insertSelective(OrderShipping record);
     ...
     * @Date: 3/22 8:27
     */
    ResponseEntity updateByPrimaryKeySelective(OrderShipping record);
     ...
     * @Date: 3/22 8:28
     */
    ResponseEntity updateByPrimaryKey(OrderShipping record);
     ...
     * @Date: 3/22 8:28
     */
    ResponseEntity getPage(OrderShipping record);
}
