...
public interface ProductReviewsMapper {
     ...
     * @Date: 2021/3/22 8:27
     */
    ProductReviewsEntity selectByPrimaryKey(String id);
     ...
     * @Date: 2021/3/22 8:28
     */
    List<ProductReviewsEntity> getPage(ProductReviews record);
     ...
     * @Date: 2021/3/22 8:28
     */
    List<ProductReviewsEntity> getOrderPage(ProductReviews record);
}